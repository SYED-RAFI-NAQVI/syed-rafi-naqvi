...
USER_NAME = os.environ.get('USER_NAME', 'SYED-RAFI-NAQVI') # 'SYED-RAFI-NAQVI'
...
if __name__ == '__main__':
    """
    Andrew Grant (SYED-RAFI-NAQVI), 2022-2025
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username 'SYED-RAFI-NAQVI'
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user SYED-RAFI-NAQVI
